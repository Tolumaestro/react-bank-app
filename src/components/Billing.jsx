    ...
    <section id="product" className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ac ante odio. Aenean viverra semper finibus. Curabitur eu neque nulla. Aliquam ut elit et magna lacinia pellentesque.
        </p>
